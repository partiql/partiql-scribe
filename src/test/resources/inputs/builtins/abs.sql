...
--#[abs-select-7]
SELECT ABS(-2147483647) FROM T;

--#[abs-select-8]
SELECT ABS(2147483647) FROM T;

--#[abs-select-9]
SELECT ABS(-9223372036854775807) FROM T;

--#[abs-select-10]
SELECT ABS(9223372036854775807) FROM T;

--#[abs-select-11]
SELECT ABS(-1.7976931348623157E308) FROM T;

--#[abs-select-12]
SELECT ABS(1.7976931348623157E308) FROM T;

--#[abs-select-13]
SELECT ABS(-3.4028235E38) FROM T;

--#[abs-select-14]
SELECT ABS(3.4028235E38) FROM T;

--#[abs-select-15]
SELECT ABS(CAST(-42 AS TINYINT)) FROM T;

--#[abs-select-16]
SELECT ABS(CAST(-1000 AS SMALLINT)) FROM T;

--#[abs-select-17]
SELECT ABS(CAST(-100000 AS BIGINT)) FROM T;

--#[abs-select-18]
SELECT ABS(CAST(-99.99 AS DECIMAL(10,2))) FROM T;

--#[abs-select-19]
SELECT ABS(CAST(-123.456 AS REAL)) FROM T;
...
--#[abs-select-21]
SELECT ABS(T.col_int32) FROM T;

--#[abs-select-22]
SELECT ABS(T.col_float32) FROM T;

--#[abs-select-23]
SELECT ABS(T.col_float64) FROM T;

--#[abs-select-24]
SELECT ABS(T.col_decimal) FROM T;
...
SELECT ABS(INTERVAL '-1' YEAR) FROM T;

--#[abs-interval-select-2]
SELECT ABS(INTERVAL '1' YEAR) FROM T;

--#[abs-interval-select-3]
SELECT ABS(INTERVAL '-5' MONTH) FROM T;

--#[abs-interval-select-4]
SELECT ABS(INTERVAL '5' MONTH) FROM T;

--#[abs-interval-select-5]
SELECT ABS(INTERVAL '-10' DAY) FROM T;

--#[abs-interval-select-6]
SELECT ABS(INTERVAL '10' DAY) FROM T;

--#[abs-interval-select-7]
SELECT ABS(INTERVAL '-2' HOUR) FROM T;

--#[abs-interval-select-8]
SELECT ABS(INTERVAL '2' HOUR) FROM T;

--#[abs-interval-select-9]
SELECT ABS(INTERVAL '-30' MINUTE) FROM T;

--#[abs-interval-select-10]
SELECT ABS(INTERVAL '30' MINUTE) FROM T;

--#[abs-interval-select-11]
SELECT ABS(INTERVAL '-45' SECOND) FROM T;

--#[abs-interval-select-12]
SELECT ABS(INTERVAL '45' SECOND) FROM T;

--#[abs-interval-select-13]
SELECT ABS(INTERVAL '-1-6' YEAR TO MONTH) FROM T;

--#[abs-interval-select-14]
SELECT ABS(INTERVAL '1-6' YEAR TO MONTH) FROM T;

--#[abs-interval-select-15]
SELECT ABS(INTERVAL '-5 10' DAY TO HOUR) FROM T;

--#[abs-interval-select-16]
SELECT ABS(INTERVAL '5 10' DAY TO HOUR) FROM T;

--#[abs-interval-select-17]
SELECT ABS(INTERVAL '-5 10:30' DAY TO MINUTE) FROM T;

--#[abs-interval-select-18]
SELECT ABS(INTERVAL '5 10:30' DAY TO MINUTE) FROM T;

--#[abs-interval-select-19]
SELECT ABS(INTERVAL '-5 10:30:45' DAY TO SECOND) FROM T;

--#[abs-interval-select-20]
SELECT ABS(INTERVAL '5 10:30:45' DAY TO SECOND) FROM T;

--#[abs-interval-select-21]
SELECT ABS(INTERVAL '-10:30' HOUR TO MINUTE) FROM T;

--#[abs-interval-select-22]
SELECT ABS(INTERVAL '10:30' HOUR TO MINUTE) FROM T;

--#[abs-interval-select-23]
SELECT ABS(INTERVAL '-10:30:45' HOUR TO SECOND) FROM T;

--#[abs-interval-select-24]
SELECT ABS(INTERVAL '10:30:45' HOUR TO SECOND) FROM T;

--#[abs-interval-select-25]
SELECT ABS(INTERVAL '-30:45' MINUTE TO SECOND) FROM T;
