...
--#[datetime-22]
SELECT DATE_DIFF(SECOND, TIMESTAMP '2017-01-02T03:04:05.006', TIMESTAMP '2017-01-02T03:04:20.006') FROM T;
...
--#[datetime-24]
SELECT * FROM datatypes.T_TIMESTAMP AS t WHERE t.foo.keep > DATE_ADD(DAY, -180, TIMESTAMP '2023-10-19 12:34:56');
