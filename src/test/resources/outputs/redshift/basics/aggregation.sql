...
SELECT "T"."a", count(1) AS "_1", sum("T"."b") AS "_2", avg("T"."b") AS "_3" FROM "default"."T" AS "T" GROUP BY "T"."a";

--#[rel-aggregation-multiple-group-00]
SELECT "T"."a", "T"."c", count(1) AS "_1" FROM "default"."T" AS "T" GROUP BY "T"."a", "T"."c";

--#[rel-aggregation-multiple-group-01]
SELECT "T"."a", "T"."c", sum("T"."b") AS "_1", avg("T"."b") AS "_2" FROM "default"."T" AS "T" GROUP BY "T"."a", "T"."c";

--#[rel-aggregation-multiple-group-02]
SELECT sum("T"."b") AS "_1", "T"."a", avg("T"."b") AS "_2", "T"."c" FROM "default"."T" AS "T" GROUP BY "T"."a", "T"."c";

--#[rel-aggregation-where-group-00]
SELECT "T"."a", count(1) AS "_1" FROM "default"."T" AS "T" WHERE "T"."b" > 0 GROUP BY "T"."a";
