...
--#[dt-minus-dt-00]
SELECT CAST("T"."col_date" AS DATE) - CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";

-- --#[dt-minus-dt-01]
-- time/datetime related subtraction not working https://github.com/partiql/partiql-scribe/issues/120
-- SELECT CAST("T"."col_time" AS TIME) - CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--
-- --#[dt-minus-dt-02]
-- time/datetime related subtraction not working https://github.com/partiql/partiql-scribe/issues/120
...
-- --#[dt-minus-dt-03]
-- time/datetime related subtraction not working https://github.com/partiql/partiql-scribe/issues/120
-- SELECT CAST("T"."col_timestamp" AS TIMESTAMP) - CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--
-- --#[dt-minus-dt-04]
-- time/datetime related subtraction not working https://github.com/partiql/partiql-scribe/issues/120
...
--#[dt-plus-interval-00]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_y" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-01]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_mon" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-02]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_d" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-03]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_h" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-04]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_min" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-05]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_s" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-06]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_y2mon" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-07]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_d2h" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-08]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_d2min" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-09]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_d2s" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-10]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_h2min" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-11]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_h2s" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-12]
SELECT CAST("T"."col_date" AS DATE) + "T"."col_m2s" AS "res" FROM "default"."T_INTERVALS" AS "T";

-- By SQL2023: 6.42, error
-- --#[dt-plus-interval-13]
-- SELECT CAST("T"."col_time" AS TIME) + "T"."col_y" AS "res" FROM "default"."T_INTERVALS" AS "T";
-- By SQL2023: 6.42, error
-- --#[dt-plus-interval-14]
-- SELECT CAST("T"."col_time" AS TIME) + "T"."col_mon" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-15]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_d" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-16]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_h" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-17]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_min" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-18]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_s" AS "res" FROM "default"."T_INTERVALS" AS "T";
-- By SQL2023: 6.42, error
-- --#[dt-plus-interval-19]
-- SELECT CAST("T"."col_time" AS TIME) + "T"."col_y2mon" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-20]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_d2h" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-21]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_d2min" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-22]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_d2s" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-23]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_h2min" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-24]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_h2s" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-25]
SELECT CAST("T"."col_time" AS TIME) + "T"."col_m2s" AS "res" FROM "default"."T_INTERVALS" AS "T";
...
--#[dt-plus-interval-40]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_mon" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-41]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_d" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-42]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_h" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-43]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_min" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-44]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_s" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-45]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_y2mon" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-46]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_d2h" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-47]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_d2min" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-48]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_d2s" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-49]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_h2min" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-50]
SELECT CAST("T"."col_timestamp" AS TIMESTAMP) + "T"."col_h2s" AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[dt-plus-interval-51]
...
--#[interval-plus-00]
SELECT "T"."col_y" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-01]
SELECT "T"."col_mon" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-02]
SELECT "T"."col_d" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-03]
SELECT "T"."col_h" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-04]
SELECT "T"."col_min" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-05]
SELECT "T"."col_s" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-06]
SELECT "T"."col_y2mon" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-07]
SELECT "T"."col_d2h" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-08]
SELECT "T"."col_d2min" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-09]
SELECT "T"."col_d2s" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-10]
SELECT "T"."col_h2min" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-11]
SELECT "T"."col_h2s" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-12]
SELECT "T"."col_m2s" + CAST("T"."col_date" AS DATE) AS "res" FROM "default"."T_INTERVALS" AS "T";

-- By SQL2023: 6.42, error
-- --#[interval-plus-13]
-- SELECT "T"."col_y" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
-- By SQL2023: 6.42, error
-- --#[interval-plus-14]
-- SELECT "T"."col_mon" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-15]
SELECT "T"."col_d" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-16]
SELECT "T"."col_h" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-17]
SELECT "T"."col_min" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-18]
SELECT "T"."col_s" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
-- By SQL2023: 6.42, error
-- --#[interval-plus-19]
-- SELECT "T"."col_y2mon" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-20]
SELECT "T"."col_d2h" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-21]
SELECT "T"."col_d2min" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-22]
SELECT "T"."col_d2s" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-23]
SELECT "T"."col_h2min" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-24]
SELECT "T"."col_h2s" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-25]
SELECT "T"."col_m2s" + CAST("T"."col_time" AS TIME) AS "res" FROM "default"."T_INTERVALS" AS "T";
...
--#[interval-plus-40]
SELECT "T"."col_mon" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-41]
SELECT "T"."col_d" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-42]
SELECT "T"."col_h" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-43]
SELECT "T"."col_min" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-44]
SELECT "T"."col_s" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-45]
SELECT "T"."col_y2mon" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-46]
SELECT "T"."col_d2h" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-47]
SELECT "T"."col_d2min" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-48]
SELECT "T"."col_d2s" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-49]
SELECT "T"."col_h2min" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-50]
SELECT "T"."col_h2s" + CAST("T"."col_timestamp" AS TIMESTAMP) AS "res" FROM "default"."T_INTERVALS" AS "T";
--#[interval-plus-51]
