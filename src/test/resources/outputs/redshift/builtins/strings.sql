...
--#[char-length-01]
SELECT CHAR_LENGTH(CAST("T"."d"."e" AS VARCHAR)) AS "_1" FROM "default"."T" AS "T";

--#[char-length-02]
SELECT CHAR_LENGTH(CAST("T_ALL_TYPES"."col_list_string"[1] AS VARCHAR)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T_ALL_TYPES";
