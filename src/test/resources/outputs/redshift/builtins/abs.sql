...
-- --#[abs-select-15]
-- Redshift does not support TINYINT type.
-- SELECT ABS(CAST(-42 AS SMALLINT)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";;
...
-- #[abs-select-20]
-- Redshift does not support ABS(null)
...
-- Redshift does not support ABS(INTERVAL)