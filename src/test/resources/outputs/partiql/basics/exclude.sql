...
SELECT "t"['flds'] AS "flds" EXCLUDE "t".foo FROM "default"."EXCLUDE_T" AS "t";
-- previous output before `SELECT *` expansion:
-- SELECT "t".* EXCLUDE "t".foo FROM "default"."EXCLUDE_T" AS "t";

--#[exclude-01]
SELECT "t"['foo'] AS "foo" EXCLUDE "t".flds FROM "default"."EXCLUDE_T" AS "t";
-- previous output before `SELECT *` expansion:
-- SELECT "t".* EXCLUDE "t".flds FROM "default"."EXCLUDE_T" AS "t";

--#[exclude-02]
SELECT "t"['flds'] AS "flds", "t"['foo'] AS "foo" EXCLUDE "t".flds.b FROM "default"."EXCLUDE_T" AS "t";
-- previous output before `SELECT *` expansion:
-- SELECT "t".* EXCLUDE "t".flds.b FROM "default"."EXCLUDE_T" AS "t";

--#[exclude-03]
SELECT "t"['flds'] AS "flds", "t"['foo'] AS "foo" EXCLUDE "t".flds.c.field_x FROM "default"."EXCLUDE_T" AS "t";
-- previous output before `SELECT *` expansion:
-- SELECT "t".* EXCLUDE "t".flds.c.field_x FROM "default"."EXCLUDE_T" AS "t";

--#[exclude-04]
-- Exclude two nested fields
SELECT "t"['flds'] AS "flds", "t"['foo'] AS "foo" EXCLUDE "t".flds.b, "t".flds.c.field_x FROM "default"."EXCLUDE_T" AS "t";
-- previous output before `SELECT *` expansion:
-- SELECT "t".* EXCLUDE "t".flds.b, "t".flds.c.field_x FROM "default"."EXCLUDE_T" AS "t";

--#[exclude-05]
SELECT "t"['flds'] AS "flds", "t"['foo'] AS "foo" EXCLUDE "t".flds.c.field_y FROM "default"."EXCLUDE_T" AS "t";
-- previous output before `SELECT *` expansion:
-- SELECT "t".* EXCLUDE "t".flds.c.field_y FROM "default"."EXCLUDE_T" AS "t";

--#[exclude-06]
-- Exclude all the fields of `t.flds.c`
SELECT "t"['flds'] AS "flds", "t"['foo'] AS "foo" EXCLUDE "t".flds.c.field_x, "t".flds.c.field_y FROM "default"."EXCLUDE_T" AS "t";
-- previous output before `SELECT *` expansion:
-- SELECT "t".* EXCLUDE "t".flds.c.field_x, "t".flds.c.field_y FROM "default"."EXCLUDE_T" AS "t";

-- START OF EXCLUDE with COLLECTION WILDCARD
--#[exclude-07]
SELECT "t"['a'] AS "a", "t"['foo'] AS "foo" EXCLUDE "t".a[*].field_x FROM "default"."EXCLUDE_T_COLL_WILDCARD" AS "t";
-- previous output before `SELECT *` expansion:
-- SELECT "t".* EXCLUDE "t".a[*].field_x FROM "default"."EXCLUDE_T_COLL_WILDCARD" AS "t";

--#[exclude-08]
-- previous output before `SELECT *` expansion:
SELECT "t"['a'] AS "a", "t"['foo'] AS "foo" EXCLUDE "t".a[*].field_y FROM "default"."EXCLUDE_T_COLL_WILDCARD" AS "t";
-- SELECT "t".* EXCLUDE "t".a[*].field_y FROM "default"."EXCLUDE_T_COLL_WILDCARD" AS "t";

--#[exclude-09]
SELECT "t1"['flds'] AS "flds", "t2"['flds'] AS "flds", "t2"['foo'] AS "foo" EXCLUDE "t1".foo, "t2".flds.b, "t2".flds.c.field_x FROM "default"."EXCLUDE_T" AS "t1" INNER JOIN "default"."EXCLUDE_T" AS "t2" ON true WHERE "t1"['foo'] = "t2"['foo'];
-- previous output before `SELECT *` expansion:
...
SELECT "t1"['flds'] AS "flds", "t1"['foo'] AS "foo", "t2"['flds'] AS "flds", "t2"['foo'] AS "foo", "t3"['flds'] AS "flds", "t3"['foo'] AS "foo" EXCLUDE "t1".flds.a, "t2".flds.b, "t3".flds.c FROM "default"."EXCLUDE_T" AS "t1" INNER JOIN "default"."EXCLUDE_T" AS "t2" ON true INNER JOIN "default"."EXCLUDE_T" AS "t3" ON true WHERE ("t1"['foo'] = "t2"['foo']) AND ("t2"['foo'] = "t3"['foo']);
-- previous output before `SELECT *` expansion:
