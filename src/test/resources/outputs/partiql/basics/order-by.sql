...
--#[order-by-08]
(SELECT "T"['a'] AS "a", "T"['b'] AS "b" FROM "default"."T" AS "T" ORDER BY "T"['a'] ASC NULLS LAST, "T"['b'] ASC NULLS LAST) UNION DISTINCT (SELECT "T"['a'] AS "a", "T"['b'] AS "b" FROM "default"."T" AS "T" ORDER BY "T"['a'] ASC NULLS LAST, "T"['b'] ASC NULLS LAST) ORDER BY "_1"['a'] ASC NULLS LAST;

--#[order-by-09]
(SELECT "T"['a'] AS "a", "T"['b'] AS "b" FROM "default"."T" AS "T" ORDER BY "T"['a'] ASC NULLS LAST, "T"['b'] ASC NULLS LAST LIMIT 1 OFFSET 2) UNION DISTINCT (SELECT "T"['a'] AS "a", "T"['b'] AS "b" FROM "default"."T" AS "T" ORDER BY "T"['a'] ASC NULLS LAST, "T"['b'] ASC NULLS LAST LIMIT 3 OFFSET 4) ORDER BY "_1"['a'] ASC NULLS LAST LIMIT 5 OFFSET 6;

--#[order-by-10]
(SELECT "T"['flds'] AS "flds" FROM "default"."EXCLUDE_T" AS "T") UNION DISTINCT (SELECT "T"['flds'] AS "flds" FROM "default"."EXCLUDE_T" AS "T") ORDER BY "_1"['flds']['c']['field_x'] ASC NULLS LAST;
...
--#[order-by-12]
SELECT "a" AS "a", max("T"['b']) AS "mx" FROM "default"."T" AS "T" GROUP BY "T"['a'] ORDER BY max("T"['b']) ASC NULLS LAST;
