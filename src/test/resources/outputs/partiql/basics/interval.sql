...
--#[interval-02]
SELECT INTERVAL '10' YEAR (2) AS "i" FROM "default"."T" AS "T";
...
--#[interval-06]
SELECT INTERVAL '10' MONTH (2) AS "i" FROM "default"."T" AS "T";
...
--#[interval-10]
SELECT INTERVAL '10' DAY (2) AS "i" FROM "default"."T" AS "T";
...
--#[interval-14]
SELECT INTERVAL '10' HOUR (2) AS "i" FROM "default"."T" AS "T";
...
--#[interval-18]
SELECT INTERVAL '10' MINUTE (2) AS "i" FROM "default"."T" AS "T";
...
--#[interval-22]
SELECT INTERVAL '10' SECOND (2) AS "i" FROM "default"."T" AS "T";

--#[interval-23]
SELECT INTERVAL '-10' SECOND (2) AS "i" FROM "default"."T" AS "T";

--#[interval-24]
SELECT INTERVAL '10.234' SECOND (2, 3) AS "i" FROM "default"."T" AS "T";
...
--#[interval-28]
SELECT INTERVAL '10-3' YEAR (2) TO MONTH AS "i" FROM "default"."T" AS "T";
...
--#[interval-32]
SELECT INTERVAL '10 3' DAY (2) TO HOUR AS "i" FROM "default"."T" AS "T";
...
--#[interval-36]
SELECT INTERVAL '10 3:4' DAY (2) TO MINUTE AS "i" FROM "default"."T" AS "T";
...
--#[interval-40]
SELECT INTERVAL '10 3:4:5' DAY (2) TO SECOND AS "i" FROM "default"."T" AS "T";
...
--#[interval-44]
SELECT INTERVAL '10 3:4:5.678' DAY (2) TO SECOND (3) AS "i" FROM "default"."T" AS "T";
...
--#[interval-48]
SELECT INTERVAL '3:4' HOUR (2) TO MINUTE AS "i" FROM "default"."T" AS "T";
...
--#[interval-52]
SELECT INTERVAL '2:3:4' HOUR (2) TO SECOND AS "i" FROM "default"."T" AS "T";
...
--#[interval-56]
SELECT INTERVAL '2:3:4.567' HOUR (2) TO SECOND (3) AS "i" FROM "default"."T" AS "T";
...
--#[interval-60]
SELECT INTERVAL '3:4' MINUTE (2) TO SECOND AS "i" FROM "default"."T" AS "T";
...
--#[interval-75]
SELECT INTERVAL '100' HOUR (3) AS "i" FROM "default"."T" AS "T";

--#[interval-76]
SELECT INTERVAL '2000' MINUTE (4) AS "i" FROM "default"."T" AS "T";

--#[interval-77]
SELECT INTERVAL '100000' SECOND (6) AS "i" FROM "default"."T" AS "T";