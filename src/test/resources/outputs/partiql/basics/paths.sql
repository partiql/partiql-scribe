...
-- TODO FIX ME, (var t) is unresolved
-- #[paths-sfw-04]
-- tuple navigation with explicit cast as string
-- SELECT "t".x[CAST("t".z AS STRING)] AS "v" FROM t AS "t";
...
-- TODO FIX ME, (var t) is unresolved
-- #[paths-sfw-07]
-- SELECT "t".x.y[0][CAST("t".z AS STRING)] AS "v" FROM t AS "t";
...
-- TODO FIX ME, (var t) is unresolved
-- #[paths-sfw-09]
-- SELECT "t".x.y['y'][CAST("t".z AS STRING)] AS "v" FROM t AS "t";
...
-- TODO FIX ME, (var t) is unresolved
-- #[paths-sfw-12]
-- SELECT "t".x[0]['y'][CAST("t".z AS STRING)] AS "v" FROM t AS "t";
