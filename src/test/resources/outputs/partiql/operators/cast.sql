...
--#[cast-74]
SELECT CAST(TIMESTAMP '2023-01-15 12:30:45' AS TIMESTAMP (6) WITH TIME ZONE) > TIMESTAMP WITH TIME ZONE '2023-01-15 10:15:30+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[cast-75]
SELECT CAST(TIMESTAMP '2023-01-15 12:30:45' AS TIMESTAMP (6) WITH TIME ZONE) > TIMESTAMP WITH TIME ZONE '2023-01-15 10:15:30+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[cast-76]
SELECT CAST(TIMESTAMP '2023-01-15 12:30:45' AS TIMESTAMP (3) WITH TIME ZONE) > TIMESTAMP WITH TIME ZONE '2023-01-15 10:15:30+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[cast-77]
SELECT CAST(TIMESTAMP '2023-01-15 12:30:45' AS TIMESTAMP (3) WITH TIME ZONE) > TIMESTAMP WITH TIME ZONE '2023-01-15 10:15:30+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[cast-78]
SELECT CAST(TIMESTAMP '2023-01-15 12:30:45' AS TIMESTAMP WITH TIME ZONE) > TIMESTAMP WITH TIME ZONE '2023-01-15 10:15:30+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";
