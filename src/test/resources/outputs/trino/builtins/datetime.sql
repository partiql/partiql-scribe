...
--#[datetime-42]
SELECT date_diff('second', CAST("T"."col_time" AS TIME), "T"."col_timez") AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[datetime-43]
SELECT date_diff('second', "T"."col_timez", CAST("T"."col_time" AS TIME)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";
...
--#[datetime-55]
SELECT date_diff('second', CAST(TIME '12:34:56' AS TIME), TIME '13:45:00+08:00') AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[datetime-56]
SELECT date_diff('second', TIME '12:34:56+08:00', CAST(TIME '13:45:00' AS TIME)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";
