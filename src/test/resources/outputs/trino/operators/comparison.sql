...
SELECT CAST("T"."col_time" AS TIME) > "T"."col_timez" AS "_1" FROM "default"."T_ALL_TYPES" AS "T";
...
SELECT "T"."col_timez" > CAST("T"."col_time" AS TIME) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";
...
SELECT CAST(TIME '12:30:45' AS TIME (6)) > TIME '10:15:30+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-57]
SELECT CAST(TIME '12:30:45' AS TIME (6)) < TIME '14:45:00+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-58]
SELECT CAST(TIME '12:30:45' AS TIME (6)) >= TIME '12:30:45+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-59]
SELECT CAST(TIME '12:30:45' AS TIME (6)) <= TIME '12:30:45+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-60]
SELECT TIME '12:30:45+08:00' > CAST(TIME '10:15:30' AS TIME (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-61]
SELECT TIME '12:30:45+08:00' < CAST(TIME '14:45:00' AS TIME (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-62]
SELECT TIME '12:30:45+08:00' >= CAST(TIME '12:30:45' AS TIME (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";
...
SELECT CAST(DATE '2023-12-25' AS TIMESTAMP (6)) > TIMESTAMP '2023-06-15 08:00:00+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-77]
SELECT CAST(DATE '2023-12-25' AS TIMESTAMP (6)) < TIMESTAMP '2024-01-01 00:00:00+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-78]
SELECT CAST(DATE '2023-12-25' AS TIMESTAMP (6)) >= TIMESTAMP '2023-12-25 00:00:00+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-79]
SELECT CAST(DATE '2023-12-25' AS TIMESTAMP (6)) <= TIMESTAMP '2023-12-25 23:59:59+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";
...
SELECT CAST(TIMESTAMP '2023-12-25 12:30:45' AS TIMESTAMP (6)) > TIMESTAMP '2023-06-15 08:00:00+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-89]
SELECT CAST(TIMESTAMP '2023-12-25 12:30:45' AS TIMESTAMP (6)) < TIMESTAMP '2024-01-01 00:00:00+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-90]
SELECT CAST(TIMESTAMP '2023-12-25 12:30:45' AS TIMESTAMP (6)) >= TIMESTAMP '2023-12-25 12:30:45+08:00' AS "_1" FROM "default"."T_ALL_TYPES" AS "T";
...
SELECT TIMESTAMP '2023-12-25 12:30:45+08:00' > CAST(DATE '2023-06-15' AS TIMESTAMP (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-93]
SELECT TIMESTAMP '2023-12-25 12:30:45+08:00' < CAST(DATE '2024-01-01' AS TIMESTAMP (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-94]
SELECT TIMESTAMP '2023-12-25 12:30:45+08:00' >= CAST(DATE '2023-12-25' AS TIMESTAMP (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-95]
SELECT TIMESTAMP '2023-12-25 12:30:45+08:00' <= CAST(DATE '2023-12-25' AS TIMESTAMP (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-96]
SELECT TIMESTAMP '2023-12-25 12:30:45+08:00' > CAST(TIMESTAMP '2023-06-15 08:00:00' AS TIMESTAMP (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-97]
SELECT TIMESTAMP '2023-12-25 12:30:45+08:00' < CAST(TIMESTAMP '2024-01-01 00:00:00' AS TIMESTAMP (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";

--#[comparison-datetime-98]
SELECT TIMESTAMP '2023-12-25 12:30:45+08:00' >= CAST(TIMESTAMP '2023-12-25 12:30:45' AS TIMESTAMP (6)) AS "_1" FROM "default"."T_ALL_TYPES" AS "T";
