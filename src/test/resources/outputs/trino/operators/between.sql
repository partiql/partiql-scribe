...
SELECT "T_DECIMALS"."da" AS "da" FROM "default"."T_DECIMALS" AS "T_DECIMALS" WHERE "T_DECIMALS"."da" BETWEEN CAST(-CAST('9223372036854775809' AS DECIMAL(38,0)) AS DECIMAL) AND CAST(CAST('9223372036854775808' AS DECIMAL(38,0)) AS DECIMAL);
--#[between-04]
...
SELECT "T_DECIMALS"."de" AS "de" FROM "default"."T_DECIMALS" AS "T_DECIMALS" WHERE CAST("T_DECIMALS"."de" AS DECIMAL) BETWEEN CAST(-CAST('9223372036854775809' AS DECIMAL(38,0)) AS DECIMAL) AND CAST(CAST('9223372036854775808' AS DECIMAL(38,0)) AS DECIMAL);
